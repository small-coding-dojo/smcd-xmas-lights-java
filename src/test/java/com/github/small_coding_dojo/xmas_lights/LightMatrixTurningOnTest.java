...
class LightMatrixTurningOnTest {
    ...
    private static Stream<Arguments> provideTestAreas() {
        return Stream.of(
                Arguments.of(new Area(0, 0, 0, 0), 1, "From 0,0 to 0,0 => One Light"),
                Arguments.of(new Area(0, 0, 999, 999), 1_000_000, "From 0,0 to 999,999 => One Million Lights"),
                Arguments.of(new Area(0, 15, 0, 16), 2, "From 0,15 to 0,16 => Two Lights"),
                Arguments.of(new Area(0, 0, 0, 1), 2, "From 0,0 to 0,1 => Two Lights")
        );
    }
    ...
    void turnOnTwoLights() {
        ...
        testee.turnOn(new Area(1, 1, 1, 1));
    ...
    void fromUnlitMatrix(Area area, int expectedBrightness, String theMessage) {
        testee.turnOn(area);
